...
%\newcommand{\memberpositive}{m182_1988_1995} 
...
% ****************************************************************************************************
\newcommand{\myTitle}{{Decadal variations} \\ {of the Southern Ocean carbon sink} \\{in 100 historical MPI-ESM ensemble simulations}\xspace}
...
\newcommand{\myBirthplace}{Frankfurt/Main\xspace}
...
\usepackage[position=top]{subfig}  %https://texblog.org/2014/01/23/sub-caption-above-subfigures-and-subtables/
\captionsetup[subfigure]{justification=justified,singlelinecheck=false} %https://tex.stackexchange.com/questions/152692/left-align-captions-with-respect-to-subfigure#152695
% ****************************************************************************************************
