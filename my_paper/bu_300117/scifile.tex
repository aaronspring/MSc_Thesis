...
\centering
\includegraphics[scale=.6,trim=0cm 6cm 0cm 5cm,clip]{seasonality_intpp_zmld_area50} % from gfx folder
%\vspace{-1cm}
...
\begin{figure}
\includegraphics[scale=.85,trim=1.2cm 13.2cm 0cm 7cm,clip]{m182_1988_1995_positive_trend_8_schwerpunkt_mixing_overview.pdf}
...
\begin{figure}
\includegraphics[scale=.5,trim=0cm 0cm 0cm 0cm,clip]{nutrient_limitation.png} % from gfx folder
...
\begin{figure}
\includegraphics[scale=.4,trim=0cm 0cm 0cm 0cm,clip]{zmld.png} % from gfx folder
...
\begin{figure}
\includegraphics[scale=.2,trim=0cm 0cm 0cm 6cm,clip]{sam_timeseries_son.png} % from gfx folder
