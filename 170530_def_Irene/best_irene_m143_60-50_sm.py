...
tho=278.112-273.15 #start
sao=33.9917        #start
#tho=277.64-273.15 #end
#sao=34.07				 #end

#aug
tho=277.07-273.15 #month start
sao=33.9935       

#tho=277.6-273.15 #month end
#sao=34.03
...
actpco2=f1.variables['pco2'][0,0,0,0]
# first month
actalk=fstart.variables['surf_alkali'][0,0,0,0]*1.e3
actdic=fstart.variables['surf_sco212'][0,0,0,0]*1.e3 # concentration units: m mol C m-3 
actpco2=fstart.variables['pco2'][0,0,0,0]




print("actalk=",actalk,"; actdic=",actdic)
mld=90.#f1.variables['zmld'][0,0,0,0]
### BIO
# coex90
...
### exchange irene
actpco2_atm=f1.variables['pco2_atm'][0,0,0,0]
actpco2_ocef=f1.variables['pco2'][0,0,0,0]
actkwf=f1.variables['co2flux'][0,0,0,0]/f1.variables['dpco2'][0,0,0,0]
dicpco2_atm=actdic-(actkwf*(actpco2_ocef-actpco2_atm))/12.*1000.*1000.*3600.*24.*30./mld*12.
alkpco2_atm=actalk
...
# rsidual
resdic=actdic-(dicpco2_atm-actdic)-(dicbio-actdic)-(dicpem-actdic)
resalk=actalk-(alkpco2_atm-actalk)-(alkbio-actalk)-(alkpem-actalk)
...
actpco2e=f1.variables['pco2'][7,0,0,0]
#last month
actalke=fstart.variables['surf_alkali'][95,0,0,0]*1.e3
actdice=fstart.variables['surf_sco212'][95,0,0,0]*1.e3
actpco2e=fstart.variables['pco2'][95,0,0,0]





mlde=90.#f1.variables['zmld'][7,0,0,0]
### BIO
# coex90
...
### exchange irene
actpco2_atme=f1.variables['pco2_atm'][7,0,0,0]
dicpco2_atme=actdice-(actkwf*(actpco2_ocef-actpco2_atme))/12.*1000.*1000.*3600.*24.*30./mlde*12.
alkpco2_atme=actalke
print("dicpco2_atme = ",dicpco2_atme,"; actkwf = ",actkwf)


### freshwater
actpeme=f1.variables['pem'][7,0,0,0]*3600.*24.*30.*12. # org units m/s
print("actpeme=",actpeme,"; meters/month water flux into ocean")
dicpeme=actdice*mlde/(mlde+actpeme)
alkpeme=actalke*mlde/(mlde+actpeme)

print("FW: dicpeme=",dicpeme,"; alkpeme=",alkpeme)

#res																																			#thermal #salt
resdice=actdice-(dicpco2_atme-actdice)-(dicbioe-actdice)-(dicpeme-actdice)
resalke=actalke-(alkpco2_atme-actalke)-(alkbioe-actalke)-(alkpeme-actalke)
...
#plt trends
plt.plot([actdic,actdic+dicpeme-actdice-dicpem+actdic],[actalk,actalk+alkpeme-actalke-alkpem+actalk],lw=2,color='y',label="fw")
plt.plot([actdic,actdic+diccoex90e-actdice-diccoex90+actdic],[actalk,actalk+alkcoex90e-actalke-alkcoex90+actalk],lw=2,color='c',label="coex90")
plt.plot([actdic,actdic+diccaex90e-actdice-diccaex90+actdic],[actalk,actalk+alkcaex90e-actalke-alkcaex90+actalk],lw=2,color='m',label="caex90")
plt.plot([actdic,actdic+dicpco2_atme-actdice-dicpco2_atm+actdic],[actalk,actalk+alkpco2_atme-actalke-alkpco2_atm+actalk],lw=2,color='r',label="pco2_atm")
#plt.plot([actdic,actdic+dicpco2_atme-actdice-dicpco2_atm+actdic],[actalk,actalk+alkpco2_atme-actalke-alkpco2_atm+actalk],lw=2,color='r',label="pco2_atm")
