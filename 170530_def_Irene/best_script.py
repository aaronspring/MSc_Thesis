...
### BIO
# coex90
#actcoex90=f1.variables['intpp'][0,0,0,0]*3600.*24.*30./90.*1000.*12.
actcoex90=f1.variables['coex90'][0,0,0,0]*3600.*24.*30./mld*1000.*12.
#actcaex90=f1.variables['intdelcar'][0,0,0,0]*3600.*24.*30./90.*1000.*12.
...
### exchange
actco2flux=f1.variables['co2flux'][0,0,0,0]/12.*1000.*1000.*3600.*24.*30./90.*12.
...
dicpem=actdic*(90.+actpem)/90.
alkpem=actalk*(90.+actpem)/90.
...
### BIO
# coex90
#actcoex90e=f1.variables['intpp'][7,0,0,0]*3600.*24.*30./90.*1000.*12.
...
#actcaex90e=f1.variables['intdelcar'][7,0,0,0]*3600.*24.*30./90.*1000.*12.
...
### exchange
actco2fluxe=f1.variables['co2flux'][7,0,0,0]/12.*1000.*1000.*3600.*24.*30./90.*12.
...
dicpeme=actdice*(90.+actpeme)/90.
alkpeme=actalke*(90.+actpeme)/90.
