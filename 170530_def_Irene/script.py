...
f1=Dataset('/work/mh0727/m300524/post/hamocc/trends_ymjm/ens178_1985_1992_positive_trend8/co2_separation_Lovenduski/lkm0178_mm_1985_1992_co2flux_separation_lovenduski.nc.fldmean_global_-60--50.nc.ymjm.nc')
...
### BIO
# coex90
actcoex90=f1.variables['intpp'][0,0,0,0]*3600.*24.*30./mld*1000.
#actcoex90=f1.variables['coex90'][0,0,0,0]*3600.*24.*30./mld*1000.
actcaex90=f1.variables['caex90'][0,0,0,0]*3600.*24.*30./mld*1000.
diccoex90=actdic-actcoex90
alkcoex90=actalk+16./122.*actcoex90
diccaex90=actdic-actcaex90
alkcaex90=actalk-2.*actcaex90
dicbio=actdic-actcaex90-actcoex90
...
### exchange
actco2flux=f1.variables['co2flux'][0,0,0,0]/12.*1000.*1000.*3600.*24.*30./mld
dicco2flux=actdic-actco2flux
alkco2flux=actalk

### freshwater
actpem=f1.variables['pem'][0,0,0,0]*3600.*24.*30. # org units m/s
...
#actdicu=1935.56
#f1.close()
#f1=Dataset('/home/stemmler/model/output/les/moni_2005.nci')
...
### BIO
# coex90
actcoex90e=f1.variables['intpp'][7,0,0,0]*3600.*24.*30./mlde*1000.
#actcoex90e=f1.variables['coex90'][7,0,0,0]*3600.*24.*30./mlde*1000.
actcaex90e=f1.variables['caex90'][7,0,0,0]*3600.*24.*30./mlde*1000.
...
### exchange
actco2fluxe=f1.variables['co2flux'][7,0,0,0]/12.*1000.*1000.*3600.*24.*30./mlde
dicco2fluxe=actdice-actco2fluxe
alkco2fluxe=actalke

### freshwater
actpeme=f1.variables['pem'][7,0,0,0]*3600.*24.*30. # org units m/s
...
print("pco2_bio_: ",pco2_bio," ",pco2_bioe," ",pco2_bioe-pco2_bio-diff)
...
#plt start of period
plt.plot(diccoex90,alkcoex90,'cx')
plt.plot(diccaex90,alkcaex90,'mx')
plt.plot(dicbio,alkbio,'go')
plt.plot(dicco2flux,alkco2flux,'ro')
plt.plot(dicpem,alkpem,'ko')

plt.plot(actdic,actalk,'bo')


#plt end of period
plt.plot(diccoex90e,alkcoex90e,'cx')
plt.plot(diccaex90e,alkcaex90e,'mx')
plt.plot(dicbioe,alkbioe,'go')
plt.plot(dicco2fluxe,alkco2fluxe,'ro')
plt.plot(dicpeme,alkpeme,'ko')

plt.plot(actdice,actalke,'bo')
...
plt.savefig('dic_alk_pco2.png',dpi=fig3.dpi)
